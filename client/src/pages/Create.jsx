      ...
      <div className="flex flex-wrap justify-center items-center gap-2 mt-10">
        <div className="flex items-center justify-center">
          <div className="flex flex-col items-center justify-center w-80 h-auto p-6 bg-white rounded-lg shadow-lg">
            ...
            >
              ...
              />
              <div className="w-12 h-12 mb-4 flex items-center justify-center bg-gray-300 rounded-full">
                <FaPlus />
              </div>
        ...
        <div className="flex items-center justify-center bg-gray-100">
          ...
          >
            ...
            <button className="bg-red-600 text-white py-1 rounded-lg hover:bg-red-700 w-full">
              Add+
            </button>
          </form>
        </div>
