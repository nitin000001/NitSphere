...
const PinPage = ({ user }) => {
  ...
  return (
    <div>
      ...
      {pin && (
        <div className="flex flex-col mt-5 items-center bg-gray-100 min-h-screen">
          {loading ? (
            <Loading />
          ) : (
              ...
              <div className="w-full md:w-1/2 p-6 flex flex-col  ">
                <div className="flex items-center justify-between mb-4 ">
                  ...
                  {pin.owner && String(pin.owner._id) === String(user._id) && (
                    <button onClick={deletePinHandler} className="bg-red-500 text-white py-1 px-3 rounded ml-4">
                      <MdDelete />
                    </button>
                  )}
                </div>
                ...
                {/* this section for comment adding and updating it */}
                ...
                <div className="scrollBar overflow-y-auto h-64">
                    ...
                    ? pin.comments.map((e, i) => (
                        <div key={i} className="flex items-center justify-center mb-4">
                          <div className="flex items-center justify-center gap-8 mb-4">
                            ...
                            { e.user === user._id && <button onClick={() => deleteCommentHandler(e._id, e.id)} className="bg-red-500 text-white py-1 px-3 rounded"> <MdDelete/> </button> }
                          </div>
                        </div>
                      ))
